# Licensing (Current OSS + Commercial Option)

This project is currently released under **Apache License 2.0**.
...
- The commercial terms are **not automatically granted** by this repository alone.
- Until a separate agreement is signed, the effective license is Apache-2.0.

Why this policy:

- Keep the project easy to adopt as OSS now
