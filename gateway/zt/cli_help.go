...
func printAdvancedUsage() {
	...
	fmt.Println("  send --client <name> [--strict | --allow-degraded-scan] [--force-public] [--update] [--sync-now] [--no-auto-sync] [--copy-command] [--share-json] [--share-format auto|ja|en] [--share-route none|stdout|clipboard|file:<path>|command-file:<path>] <file>")
	...
	fmt.Println("  verify [--sync-now] [--no-auto-sync] <packet.spkg.tgz>")
